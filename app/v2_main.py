...
from .v2_treatment_status_api import status_api

app.add_middleware(SecurityHeadersMiddleware)
app.include_router(v2_api)
app.include_router(v2_public)
# Las rutas reforzadas deben ir antes de las versiones de compatibilidad y
# de rutas dinámicas como /chemo/{item_id}.
