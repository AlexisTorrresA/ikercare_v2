...
chemo_event_action_api = APIRouter(prefix="/api/v2", tags=["IkerCare chemo event actions"])


@chemo_event_action_api.put("/patients/{patient_id}/chemo/{chemo_id}/events/{event_id}")
